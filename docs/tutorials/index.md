...
All the notebooks presented in the documentation can be played online using https://mybinder.org/
...
- [Tutorial: Auditing HAL with HALTools](https://mybinder.org/v2/gh/balouf/gismap/HEAD?urlpath=%2Fdoc%2Ftree%2Fdocs%2Ftutorials%2Fhaltools.ipynb)
