...
from gismap.gisgraphs.options import physics as def_physics, nodes as def_nodes, edges as def_edges, interaction as def_interaction
...
gislink = tags.a("&copy; Gismap 2025", _href="https://balouf.github.io/gismap/",
                              _target="_blank", _class="watermark gislink")
...
def make_vis(lab, **kwargs):
    ...
    options = {'physics': physics, 'groups': groups, 'nodes': nodes_options, 'edges': edges_options,
    ...
    script = tags.script(script.substitute(**parameters),
                         _type="module")
